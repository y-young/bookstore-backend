package com.yyoung.bookstore.search.configuration;
...
public class SwaggerConfiguration {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.yyoung.bookstore.search"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Bookstore Backend Search Microservice")
                .build();
    }
}
